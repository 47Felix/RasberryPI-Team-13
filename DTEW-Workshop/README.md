...
- **`personas-mia-tom.md`/`.html`** – ausgefülltes `persona-template.pdf` für die beiden Proto-Personas (Mia, Tom) von Case 3, auf Desk-Research + Dienstags-Notizen basierend, **noch nicht durch echte Interviews validiert** – siehe [[DTEW 0109 - Teampathy Map und Empathize]].
