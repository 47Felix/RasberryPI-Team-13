...
- **[`strategy-presentation/`](strategy-presentation)** – zusammengeführte Strategie-Präsentation für die Abschlusspräsentation / Innovation Fair (10./11.09.): Problem, Personas, Lösung/Prototyp, Social Business Model Canvas, Marketing-Strategie, Onboarding, Abgrenzung, Roadmap, Team (12 Folien, Englisch). Name/Logo, 1-Minuten-Pitch, Standbudget und Poster/Flyer sind bewusst nicht enthalten (Team-Aufgabe) – siehe [[DTEW - Strategie-Präsentation]].
