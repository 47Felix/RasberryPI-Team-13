...
- **Cron:** täglich `06:45 Europe/Berlin` (per `CRON_TZ=Europe/Berlin` in der Crontab, passt sich automatisch an Sommer-/Winterzeit an) – `crontab -l` auf der VM zeigt den aktiven Eintrag. War ursprünglich abends (19:30 UTC), auf Wunsch auf morgens umgestellt.
